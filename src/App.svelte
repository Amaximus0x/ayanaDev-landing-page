...
<div class="min-h-screen bg-light-bg-primary">
	...
	<div class="pt-[1px] md:pt-[1px]">
		...
		>
			<div
				class="w-full max-w-[384px] md:max-w-[1247px] h-auto min-h-[430px] relative bg-black/5 rounded-lg overflow-hidden mx-auto"
			>
				

				<!-- Decorative background element -->
				<div
					class="absolute w-[40%] h-[40%] md:w-[359.0623px] md:h-[359.0618px] left-[2px] md:left-[0px] bottom-0 top-[275px] md:top-[105px] overflow-hidden"
				>
					<!-- {#if isMobile} -->
						<svg
...
<style>
	...
	.gradient-border > .inner {
		background-color: #00000008; /* your original background */
		border-radius: 9999px;
	}
</style>
