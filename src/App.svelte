...
<div class="min-h-screen bg-light-bg-primary">
	...
	<div class="pt-[1px] md:pt-[1px]">
		...
		>
			<div
				class="trusted-by-container inline-flex justify-center items-center gap-[4px] pl-[4px] pr-[12px] py-[4px] rounded-[30000px] relative"
			>
		...
		<!-- Hero Section -->
		<div
			class="flex flex-col justify-center items-center gap-10 md:gap-14 mx-5 md:ml-[143px] md:mr-[142px]"
		>
			<div
		...
		<div class="flex flex-col justify-center items-center gap-6 md:gap-8 mx-5 md:ml-[97px] md:mr-[96px] mt-[71px] md:mt-[119px]">
			<div class="flex flex-col justify-center items-center gap-2 md:gap-0">
				<div class="text-center justify-center text-black text-h3-medium md:text-h2-medium font-sans capitalize">
					How we build 
				</div>
				<p class="text-center text-black text-small-mini md:text-body-italic font-sans italic">We're at the beginning of an ambitious journey. Our goal is to build a portfolio of apps that millions rely on daily.</p>
			</div>
			{#if isMobile}
		...
		<!-- Where We're Heading -->
		<div class="flex flex-col justify-center items-center gap-6 md:gap-8 mx-5 md:ml-[97px] md:mr-[96px] mt-[64px] md:mt-[38px]">
			<div class="flex flex-col justify-center items-center gap-2 md:gap-0">
				<div class="text-center justify-center text-black text-h3-medium md:text-h2-medium font-sans capitalize">
				Where We're Heading
				</div>
			...
			{#if isMobile}
			<img src="/where-we-heading-mobile.svg" alt="Where we heading">
						
			{:else}
			<div class="flex items-center justify-center gap-2">
				<img src="/where-we-heading-ls-1.svg" alt="Where we are Heading ls 1">
				<img src="/where-we-heading-ls-2.svg" alt="Where we are Heading ls 2">
			</div>
			{/if}
		</div>	
		...
		<div class="flex flex-col justify-center items-center gap-6 md:gap-8 mx-5 md:ml-[97px] md:mr-[96px] mt-[64px] md:mt-[95px]">
			<div class="flex flex-col justify-center items-center">
				<div class="text-h3-medium md:text-h2-medium font-sans capitalize">Follow Our Journey</div>
				<div class="text-body-italic font-sans capitalize">Get notified when we launch new apps</div>
			</div>
		...
		<div class="flex flex-col justify-center items-center gap-6 md:gap-8 mx-5 md:ml-[97px] md:mr-[96px] mt-[64px] md:mt-[113px]">
			<div class="w-full max-w-[384px] md:max-w-[1247px] h-96 relative bg-black/5 rounded-lg overflow-hidden">
				...
				<!-- Main content -->
				<div class="w-[350px] md:w-[802px] mx-[20px] md:mx-0 md:left-[392px] top-[74.28px] md:top-[45px] md:right-[45px] md:bottom-[45px] absolute inline-flex flex-col justify-start items-end gap-6 md:gap-[38px]">
					<div class="self-stretch flex flex-col justify-start items-stretch gap-6">
						<!-- Early Adopters -->
						<div class="flex flex-col gap-1">
							<div class="text-right text-black text-h3-medium font-light italic md:text-h2-medium font-sans capitalize">Early Adopters</div>
							<div class="text-right text-black font-light text-small-mini md:text-small-lg font-sans capitalize">Be first to try our new apps. Join our beta community for exclusive access and direct input into what we build.</div>
						</div>
						
						<!-- Strategic Partners -->
						<div class="flex flex-col gap-1">
							<div class="text-right text-black text-h3-medium font-light italic md:text-h2-medium font-sans capitalize">Strategic Partners</div>
							<div class="text-right text-black font-light text-small-mini md:text-small-lg font-sans capitalize ">Be first to try our new apps. Join our beta community for exclusive access and direct input into what we build.</div>
						</div>
						
						<!-- Exceptional Opportunities -->
						<div class="flex flex-col gap-1">
							<div class="text-right text-black text-h3-medium font-light italic md:text-h2-medium font-sans capitalize">Exceptional Opportunities</div>
							<div class="text-right text-black font-light text-small-mini md:text-small-lg font-sans capitalize">While focused on our own products, we're open to exploring unique collaborations.</div>
						</div>
					</div>
					
					<!-- Get in Touch Button -->
					<div class="px-3 py-2 md:px-6 md:py-4 bg-black rounded-lg inline-flex justify-center items-center gap-2.5">
						<div class="text-center justify-start text-white text-small-mini md:text-small-lg font-medium font-sans capitalize">Get in Touch</div>
				...
				<!-- Let's Talk Title -->
				<div class="w-[134px] h-[35px] md:w-[330px] md:h-[86px] left-[28px] md:left-[59px] top-[36.28px] md:top-[173px] absolute justify-start text-[28.9px]/[34.68px] font-bold md:text-[71.17px]/[85.41px] font-sans capitalize leading-9 bg-gradient-to-r from-black to-[#7CCCCA] bg-clip-text text-transparent">Let's Talk!</div>
			</div>
		</div>
