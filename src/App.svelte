...
<div class="min-h-screen bg-light-bg-primary">
	...
	<div class="pt-[1px] md:pt-[1px]">
		...
		<!-- Let's Talk Section -->
		<div
			class="flex flex-col justify-center items-center gap-6 lg:gap-8 mx-5 lg:ml-[97px] lg:mr-[96px] mt-[64px] lg:mt-[113px]"
		>
			<div
				class="w-full  h-auto min-h-[430px] relative bg-black/5 rounded-lg overflow-hidden mx-auto"
			>
				

				<!-- Decorative background element -->
				<div
					class="absolute w-[40%] h-[40%] lg:w-[359.0623px] lg:h-[359.0618px] left-[2px] lg:left-[0px] bottom-0 top-[275px] lg:top-[105px] overflow-hidden"
				>
					<!-- {#if isMobile} -->
						<svg
				...
				<!-- Main content -->
				<div
					class="absolute w-[94%] md:w-[802px] right-5  md:right-[45px] top-[74px] md:top-[45px] flex flex-col justify-start items-end gap-6 md:gap-[38px]"
				>
					<div
						class="self-stretch flex flex-col justify-start items-stretch gap-6"
					>
						<!-- Early Adopters -->
						<div class="flex flex-col gap-1">
							...
							<div
								class="text-right text-black font-light text-[14px] md:text-[16px] font-sans capitalize"
							>
					...
					<a
						...
						class="inline-flex items-center gap-2.5 px-4 py-2 md:px-6 md:py-4 bg-black rounded-lg hover:bg-gray-800 transition-colors duration-200 cursor-pointer"
					>
						<span
							class="text-white text-[14px] md:text-[16px] font-medium font-sans capitalize"
						>
							Get in Touch
						</span>
				...
				<!-- Let's Talk Title -->
				<div
					class="absolute left-[28px] md:left-[59px] top-[36px] md:top-[173px]"
				>
					<h2
						class="text-[28.9px] md:text-[71.17px] font-bold font-sans capitalize leading-[1.2] bg-gradient-to-r from-black to-[#7CCCCA] bg-clip-text text-transparent whitespace-nowrap"
				>
					Let's Talk!
					</h2>
				</div>
