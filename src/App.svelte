	...
	<svg xmlns="http://www.w3.org/2000/svg" width="741" height="1225" viewBox="0 0 741 1225" fill="none">
		...
		<div class="absolute top-[3600px] left-[0%] pointer-events-none z-0 block md:hidden">
			<svg xmlns="http://www.w3.org/2000/svg" width="430" height="1225" viewBox="0 0 430 1225" fill="none">
				...
				<defs>
				  <filter id="filter0_f_7578_1216" x="-400" y="0" width="1229" height="1225" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
					<feFlood flood-opacity="0" result="BackgroundImageFix"/>
					<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
					<feGaussianBlur stdDeviation="250" result="effect1_foregroundBlur_7578_1216"/>
				  </filter>
				</defs>
			  </svg>
		</div>
		...
		<div class="absolute top-[3000px] left-[0%] pointer-events-none z-0 block md:hidden flex-shrink-0">
			<svg xmlns="http://www.w3.org/2000/svg" width="430" height="225" viewBox="0 0 430 1225" fill="none">
				...
				<defs>
				  <filter id="filter0_f_7578_1214" x="-503" y="0" width="1229" height="1225" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
					<feFlood flood-opacity="0" result="BackgroundImageFix"/>
					<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
					<feGaussianBlur stdDeviation="250" result="effect1_foregroundBlur_7578_1214"/>
				  </filter>
				</defs>
			  </svg>
		</div>
		...
		<div class="absolute top-[3000px] left-[0%] pointer-events-none z-0 block md:hidden flex-shrink-0">
			<svg xmlns="http://www.w3.org/2000/svg" width="430" height="225" viewBox="0 0 430 1225" fill="none">
				...
				<defs>
				  <filter id="filter0_f_7578_1212" x="-400" y="0" width="1229" height="1225" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
					<feFlood flood-opacity="0" result="BackgroundImageFix"/>
					<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
					<feGaussianBlur stdDeviation="250" result="effect1_foregroundBlur_7578_1212"/>
				  </filter>
				</defs>
			  </svg>
		</div>
...
<!-- Footer -->
<Footer on:privacy-policy-click={handlePrivacyPolicyShow} />
