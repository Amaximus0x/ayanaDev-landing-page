	...
	<div class="pt-[1px] md:pt-[1px]">
		...
		>
			...
			>
				<!-- Gradient Background -->
				<div
					class="absolute top-0 right-0 w-[300px] h-[200px] md:w-[500px] md:h-[300px] pointer-events-none"
				>
					<img
				...
				<!-- Main content -->
				<div
					class="w-[350px] md:w-[802px] mx-[20px] md:mx-0 md:left-[392px] top-[74.28px] md:top-[45px] md:right-[45px] md:bottom-[45px] absolute inline-flex flex-col justify-start items-end gap-6 md:gap-[38px]"
				>
					<div
				...
				<!-- Let's Talk Title -->
				<div
					class="w-[134px] h-[35px] md:w-[330px] md:h-[86px] left-[28px] md:left-[59px] top-[36.28px] md:top-[173px] absolute justify-start text-[28.9px]/[34.68px] font-bold md:text-[71.17px]/[85.41px] font-sans capitalize leading-9 bg-gradient-to-r from-black to-[#7CCCCA] bg-clip-text text-transparent"
				>
					Let's Talk!
				</div>
			</div>
